...
export const SITE_CONFIG = {
    ...
    domain: process.env.NEXT_PUBLIC_DOMAIN || 'matrimony4u.com',
    url: isProd
        ? `https://${process.env.NEXT_PUBLIC_DOMAIN || 'matrimony4u.com'}`
        : 'http://localhost:3000',
    ...
    // Social
    twitter: '@matrimony4u',
    facebook: 'https://facebook.com/matrimony4u',
    linkedin: 'https://linkedin.com/company/matrimony4u',
    instagram: 'https://instagram.com/matrimony4u',

    // Founder / Author
    author: {
        name: 'Chithrai Selvan',
        role: 'Founder & Chief Architect',
        bio: 'Technical architect and legal consultant specializing in Indian matrimonial laws and wedding planning technology.',
        social: {
            linkedin: 'https://linkedin.com/in/chithraiselvan',
            twitter: 'https://twitter.com/chithraiselvan',
        }
    },
